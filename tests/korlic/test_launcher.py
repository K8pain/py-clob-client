...
from Korlic.launcher import _append_trade_log, _build_parser, _load_bot, _query_event_diagnostics, _query_events, _query_trade_counters, _setup_logger, _tail_file
...
def test_setup_logger_enables_debug_for_launcher_and_bot(tmp_path: Path):
    ...
    assert logging.getLogger("korlic-bot").level == logging.DEBUG
